class JobOffersController < ApplicationController
  ...
  private
    ...
    def job_offer_params
      params.expect(job_offer: [ :title, :description, :skills_required, :experience, :location, :relocation, :apply_from_anywhere, :remote, :english_level, :japanese_level, :salary, :employment_type, :posted_at, :closing_date, :company_id, :role_id ])
    end
end
